...
var allday = 0;
//当前月份的总天数
var flag_year = today.getFullYear();
var flag_month = today.getMonth();
...
function showDate() { 
    ...
    for (var j = 1; j <= allday; j++) {
        var dayElement = document.createElement("div");//创建div元素
        dayElement.className = "everyday";
        dayElement.innerHTML = j + ""; //将指定元素的html代码分配给变量

        //如果日期为今天，将内容显示为红色
        if ((j == day)&&(month == flag_month +1)&&(year == flag_year)) {
