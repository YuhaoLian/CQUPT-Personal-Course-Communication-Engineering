...
for gg = 0:1:4    %Guard time in samples.
    ...
    figure(1)
	subplot(211);
	semilogy(0:4:40,est_time,picture_style);
	grid on;
	hold on;
    
	subplot(212);
	semilogy(0:4:40,est_angle,picture_style);
	grid on;
    hold on;
    
    save est_time2.mat est_time;
    save est_angle2.mat est_angle;
end
figure(2)
subplot(211);
