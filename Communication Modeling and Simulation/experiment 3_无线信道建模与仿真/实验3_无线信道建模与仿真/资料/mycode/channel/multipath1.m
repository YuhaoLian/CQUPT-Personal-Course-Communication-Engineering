function  [original_signal1]=multipath( original_signal,Fc,V,Tc)
...
%temp0=trans_signal11;
 for kk = 1:data_length
       CH_Data(:,kk)=sqrt(1/N0)*sum(cos(Wm*cos(Ank)*(kk+1e8)*Tc/Sample_Rate+phi(1))+j*sin(Wm*sin(Ank)*(kk+1e8)*Tc/Sample_Rate+phi(2)))';
 end
