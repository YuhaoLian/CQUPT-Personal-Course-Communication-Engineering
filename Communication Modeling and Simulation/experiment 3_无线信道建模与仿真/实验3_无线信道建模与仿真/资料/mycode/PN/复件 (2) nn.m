...
V=5;
FrameNum=10;
SubCarrNum = 512;	%Number of carriers
...
% 		end
        ...
        Gamam_P1=Gamam_P;
        Gamam_P2 =[zeros(1,SubCarrNum+GuardNum) Gamam_P(1,1:end-(SubCarrNum+GuardNum))];
        
        Gamam_P=Gamam_P1.*Gamam_P2;
