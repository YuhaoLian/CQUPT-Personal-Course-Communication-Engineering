...
fs = 20e6; 		%System bandwith is 20MHz
V=0;
...
subplot(212);
for m = 1:M-1
    plot(0:(Info_length-1),argmax(1,(m-1)*Info_length+20:m*Info_length+19));  
    hold on
end
grid on;
...
grid on;
% 
% PN_code2=Standard_Multipath1(PN_code,fc,V,fs);
% [Crosscorrelation3,lags] = xcorr(PN_code,PN_code2,length(PN_code),'coeff');
% 
% figure(7)
