...
frequency_subchannel_time=zeros(sampleNum,subchannelNum);
frequency_band_time=zeros(sampleNum,bandNum);
frequency_subcarrier_time=zeros(sampleNum,subcarrierNum);
...
for j=1:delay_max
    ...
    if k==Path_Delay(1,n)+1
        for i=1:sampleNum
            fading_factor_tmp2(j,i)=fading_factor(n,i);
        end
        n=n+1;
    else
        for i=1:sampleNum
            fading_factor_tmp2(j,i)=0;
        end
    end
end
...
save ('frequency_band_time.mat','frequency_band_time');
